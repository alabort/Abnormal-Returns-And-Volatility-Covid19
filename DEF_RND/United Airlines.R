...
Selected_Date <- "21/04/2020"
Selected_Date2 <- "21/04/20"

#import the prices of the underlying and filter the price of the wanted day
Price <-  read.csv("UALS0.csv", header = TRUE, sep = ";", dec=".")
...
Main_table <- read.csv("UAL_TOT.csv", header = TRUE, sep = ",", dec=".")
#remember to change the date in the following line, the format should be X.dd.mm.yyyy
Date_table <- data.frame(Main_table$X21.04.2020, Main_table$Strike, Main_table$Expiry.Date, Main_table$X.NAME..y)
...
legend("topright", legend=c("18-09-2020", "15-01-2021"), col=c("black","blue","red"), 
