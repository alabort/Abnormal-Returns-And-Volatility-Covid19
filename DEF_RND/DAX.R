...
#import the prices of the DAX Index and filter the price of the wanted day
Price <-  read.csv("DAXS0.csv", header = TRUE, sep = ";", dec=".")
...
Main_table <- read.csv("DAX.csv", header = TRUE, sep = ",", dec=".")
