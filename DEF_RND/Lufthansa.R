...
Price <-  read.csv("LHS0.csv", header = TRUE, sep = ";", dec=".")
...
#the 1M, 3M, 6M and 12M rates have been downloaded from the FRED
...
Main_table <- read.csv("LU1.csv", header = TRUE, sep = ",", dec=".")
